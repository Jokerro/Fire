...
Camera camera(Vector3(0.0f, 0.0, 20.0f));
...
int Init ( ESContext *esContext )
{
	...
	//triangle data (heap)
	FILE *pFile;
	fopen_s(&pFile, "../Resources/Models/fire.nfg", "r");
	...
	Helper::loadTexture(&textureHandle, "../Resources/Textures/fire3.tga");
	Helper::loadTexture(&textureMaskHandle, "../Resources/Textures/fire_mask.tga");
	Helper::loadTexture(&textureDispHandle, "../Resources/Textures/DisplacementMap.tga");
...
void Draw ( ESContext *esContext )
{
	...
	//disp
	glActiveTexture(GL_TEXTURE0 + textureUnit);
	glBindTexture(GL_TEXTURE_2D, textureDispHandle);
	glUniform1i(myShaders.textureDispUniform, textureUnit);
